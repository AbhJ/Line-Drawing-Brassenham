...
bool check(int x_1, int y_1, int x_2, int y_2, int x_3, int y_3, int x, int y) {
	vector<double>X1{(double)x_1 - 0.499999, (double)x_1 + 0.499999};
	vector<double>Y1{(double)y_1 - 0.499999, (double)y_1 + 0.499999};
	vector<double>X2{(double)x_2 - 0.499999, (double)x_2 + 0.499999};
	vector<double>Y2{(double)y_2 - 0.499999, (double)y_2 + 0.499999};
	vector<double>X3{(double)x_3 - 0.499999, (double)x_3 + 0.499999};
	vector<double>Y3{(double)y_3 - 0.499999, (double)y_3 + 0.499999};
...
void cleanse(vector<tuple<int, int, int>>& voxelsCenters) {
	vector<tuple<int, int, int>> cleanesdVoxelCenters;
	for (auto &[x, y, z] : voxelsCenters) {
		if (x == INT_MIN or y == INT_MIN or z == INT_MIN) {
			continue;
		}
